...
module frequency1
	...
	z1 : [1..phase] init phase;// clock for phase
	f1 : [1..16] init 1; // frequency of receiver
	t1 : [0..1] init 0; // train of receiver
...
module sender_frequency
	...
	send : [1..3] init 2;   // 1 sending and 2,3 receiving
	freq  : [1..16] init 2; // current frequency mod 16 freq+train*16
	train : [0..1] init 1;  // used to work out the frequency (actual frequency equals freq+train*16)
	c : [1..16] init 1; // used to work out the trains
	rep : [1..mrep] init mrep; // no of repetitions of a train
...
//	z1=phase & f1=k & t1=T & // initial frequency of the receiver (based on its clock)
//	send=2 & freq=2 & train = 1 & c = 1 & rep=mrep // condition required on the sender
//endinit
